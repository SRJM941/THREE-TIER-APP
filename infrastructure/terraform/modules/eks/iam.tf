# IAM OIDC Identity Provider for EKS (required for IRSA)
...
# Optional IRSA Role for ExternalDNS (if you plan to use Route53)
...
resource "aws_iam_policy" "external_dns" {
  ...
  description = "Policy for ExternalDNS to update Route53"
